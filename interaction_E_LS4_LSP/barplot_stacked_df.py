...
systems = ["LSP", "LS4_PI", "LS4_FI"]
x_pos = np.arange(len(systems))
elec_mean = [LSP_elec_mean, LS4_PI_elec_mean, LS4_FI_elec_mean]
vdw_mean = [LSP_vdw_mean, LS4_PI_vdw_mean, LS4_FI_vdw_mean]
elec_std = [LSP_elec_std, LS4_PI_elec_std, LS4_FI_elec_std]
vdw_std = [LSP_vdw_std, LS4_PI_vdw_std, LS4_FI_elec_std] 
...
#plt.show()
plt.savefig("diff_energy_barplot.png")
